...
describe('ComponentFactory', () => {
  ...
  describe('listen', () => {
    it('should allow listening to on the ComponentRef', () => {
      ...
      const cleanUp1 = fixture.componentRef.listen('onChange', () => {
        logs.push('onChange');
      });
      const cleanUp2 = fixture.componentRef.listen('onSomeOtherChange', () => {
        logs.push('onSomeOtherChange');
      });
      const cleanUp3 = fixture.componentRef.listen('onDirChange', () => {
    ...
    it('should throw when listening a non-existing output', () => {
      ...
      expect(() => fixture.componentRef.listen('notAnInput', () => {})).toThrow();
    });
  });
});
